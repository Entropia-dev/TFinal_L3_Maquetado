...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        ...
        <div class="form"><asp:TextBox ID="txtGenero" runat="server" class="form-control" placeholder="Masculino/Femenino" type="text"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtGenero" ErrorMessage="Complete su genero"></asp:RequiredFieldValidator></div>        <div class="form"><asp:TextBox ID="txtAlias" runat="server" class="form-control" placeholder="Alias" type="text"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtAlias" ErrorMessage="Complete su alias"></asp:RequiredFieldValidator></div>
